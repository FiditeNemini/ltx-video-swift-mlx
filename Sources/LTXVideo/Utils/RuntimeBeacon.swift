...
/// ```
/// or set the environment variable `LTX_RUNTIME_BEACON=1` (used by the CLI's
/// `--beacon` flag as well).
///
/// ## Manifest schema (version 1)
/// The format is deliberately runtime-agnostic so other frameworks can adopt it:
/// ```json
/// {
///   "version": 1,
///   "pid": 1234,
...
public enum RuntimeBeacon {
    ...
    static let runtimeID = "ltx-video-swift-mlx"
    static let runtimeDisplayName = "LTX-Video"
    ...
    /// unless the host sets this to `true` or exports `LTX_RUNTIME_BEACON=1`.
