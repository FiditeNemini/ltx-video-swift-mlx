...
* [The vocoder's float32 policy only ever cast the runtime input, never its checkpoint weights](pitfalls/vocoder-weights-stayed-bf16.md) - every LipDub/audio generation ran BigVGAN's ~108-conv chain on bf16 weights; 2-9% relative error, ~1e-5 once the loader casts the parameters too
